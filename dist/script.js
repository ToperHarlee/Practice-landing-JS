...
/***/ "../../../04 Продвинутый JavaScript/lesson072_TEST/src/js/main.js":
/*!**************************************************************************************************************************************************************!*\
  !*** C:/Users/Вера/Desktop/LearnHtml/Курсы/Полный курс по JavaScript + React - с нуля до результата/04 Продвинутый JavaScript/lesson072_TEST/src/js/main.js ***!
  \**************************************************************************************************************************************************************/
...
var one = 1;
var two = 2; //именованый синтаксис
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); //дз и рекомендации ментора.

  var checkDataInput = function checkDataInput() {
    ...
    document.querySelectorAll('.checkbox').forEach(function (checkbox) {
      if (checkbox.checked === false || document.querySelector('.form-control').selected === false) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeModalState); //придумать валидацию чтобы пользователя не пускало на следующую страницу пока не выбрана форма или размеры(done)
...
/* harmony import */ var _04_JavaScript_lesson072_TEST_src_js_main__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../04 Продвинутый JavaScript/lesson072_TEST/src/js/main */ "../../../04 Продвинутый JavaScript/lesson072_TEST/src/js/main.js");
    ...
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        for (var _key in state) {
          // очистка данных в обьекте после отправки
          delete state[_key];
        }
...
/* harmony default export */ __webpack_exports__["default"] = (forms); //Make functional in landing, on pratice JS course
...
var modals = function modals() {
  var openModal = function openModal(modal) {
    ...
    document.body.style.overflow = 'hidden'; //document.body.classList.add('modal-open');//класс из бутстрапа - запрещает скролл при открытой модалке
  };
